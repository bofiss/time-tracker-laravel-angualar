            ...
            <div class="container-fluid time-entry">
                ...
                <div class="time-entry-comment">                
                    <form class="navbar-form">
                    	<select name="user" class="form-control" ng-model="vm.timeEntryUser" ng-options="user.nom + ' ' + user.prenom for user in vm.users">
        ...
        <div class="container">
            <div class="col-sm-8">
                ...
                <div class="well vm" ng-repeat="time in vm.timeentries">
                    <div class="row">
                        <div class="col-sm-8">
                            <h4><i class="glyphicon glyphicon-user"></i> {{time.user.nom}} {{time.user.prenom}}</h4>
                    ...
                    <div class="row edit-time-entry" ng-show="showEditDialog === true">
                        ...
                        <div class="col-sm-6">
                            <h5>User</h5>
                            <select name="user" class="form-control" ng-model="time.user" ng-options="user.nom+ ' ' + user.prenom for user in vm.users track by user.id">
