...
class UsersTableSeeder extends Seeder {
	public function run()
	{
		...
		$users = array(
				['prenom' => 'Ryan', 'nom' => 'Chenkie', 'email' => 'ryanchenkie@gmail.com', 'password' => Hash::make('secret')],
				['prenom' => 'Chris', 'nom' => 'Sevilleja', 'email' => 'chris@scotch.io', 'password' => Hash::make('secret')],
				['prenom' => 'Holly', 'nom' => 'Lloyd', 'email' => 'holly@scotch.io', 'password' => Hash::make('secret')],
				['prenom' => 'Adnan', 'nom' => 'Kukic', 'email' => 'adnan@scotch.io', 'password' => Hash::make('secret')],
		);
